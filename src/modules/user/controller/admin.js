...
import { create, find, findByIdAndUpdate, updateOne } from "../../../../DB/DBMethods.js"
import pageModel from "../../../../DB/model/Page.model.js"
...
export const handelPageContent = asyncHandler(async (req, res, next) => {
    const pageData = await findByIdAndUpdate({
        model: pageModel,
        filter: { _id: req.params.id },
        data: { sections: { data: req.body.sections } },
        options: { new: true }

    })
    return res.status(200).json({ message: `Done`, pageData })
})

export  const  getPageContent= asyncHandler(async (req, res, next) => {
